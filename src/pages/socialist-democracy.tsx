...
const SociallistDemocracy = () => {
    return (
           <div className="container mx-auto py-20 px-4">
            ...
            <div className="mt-10">
                <h2 className="text-2xl font-semibold mb-6">Thông Tin Chi Tiết Về Dân Chủ Xã Hội Chủ Nghĩa</h2>
                ...
                <Tabs defaultValue="historical-context" className="w-full text-left">
                    ...
                    <TabsContent value="practical-examples" className="border rounded-lg p-6">
                        <div className="space-y-4">
                            ...
                            <h4 className="text-lg font-medium mt-6">Cuba</h4>
                            <p>
                            ...
                            <h4 className="text-lg font-medium mt-6">Trung Quốc</h4>
                            <p>
