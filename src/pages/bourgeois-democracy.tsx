                ...
                <Tabs defaultValue="historical-context" className="w-full text-left">
                    <TabsList className="grid grid-cols-5 mb-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            {/* Right Column - Image */}
                            <div className="flex items-center justify-center">
                                <div className="rounded-lg w-full h-[350px] overflow-hidden">
                                    <img
                                        src="/images/bourgeois-democracy/french-revolution.jpg"
                                        alt="French Revolution - Birth of Bourgeois Democracy"
                                        className="w-full h-full object-cover"
                                    />
                                </div>
                            </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div className="space-y-4">
                                <div className="rounded-lg w-full h-[200px] overflow-hidden">
                                    <img
                                        src="/images/bourgeois-democracy/my-quochoi.webp"
                                        alt="Voting Booth - Democratic Process"
                                        className="w-full h-full object-cover"
                                    />
                                </div>
                                <div className="rounded-lg w-full h-[200px] overflow-hidden">
                                    <img
                                        src="/images/bourgeois-democracy/anh-nghivien.gif"
                                        alt="Economic Inequality - Class Nature of Bourgeois Democracy"
                                        className="w-full h-full object-cover"
                                    />
                                </div>
                            </div>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="flex items-center justify-center">
                                    <div className="rounded-lg w-full h-[200px] overflow-hidden">
                                        <img
                                            src="/images/bourgeois-democracy/democrat.jpg"
                                            alt="Multi-party System - Political Competition"
                                            className="w-full h-full object-cover"
                                        />
                                    </div>
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <h4 className="text-lg font-medium">2. Tam quyền phân lập</h4>
                                    <p className="mt-2">Phân chia quyền lực nhà nước thành ba nhánh độc lập:</p>
                                    <ul className="list-disc pl-6 space-y-2 mt-2">
                                ...
                                <div className="flex items-center justify-center">
                                    <div className="rounded-lg w-full h-[200px] overflow-hidden">
                                        <img
                                            src="/images/bourgeois-democracy/tam-quyen.jpg"
                                            alt="Separation of Powers - Three Branches of Government"
                                            className="w-full h-full object-cover"
                                        />
                                    </div>
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <h4 className="text-lg font-medium">3. Tự do cá nhân</h4>
                                    <p className="mt-2">Bảo đảm các quyền tự do cơ bản của công dân:</p>
                                    <ul className="list-disc pl-6 space-y-2 mt-2">
                                        <li>Tự do ngôn luận và báo chí</li>
                                        <li>Tự do tín ngường</li>
                                ...
                                <div className="flex items-center justify-center">
                                    <div className="rounded-lg w-full h-[200px] overflow-hidden">
                                        <img
                                            src="/images/bourgeois-democracy/bao-chi.jpg"
                                            alt="Individual Freedom - Civil Rights and Liberties"
                                            className="w-full h-full object-cover"
                                        />
                                    </div>
                                </div>
                            ...
                            {/* 4. Hạn chế (no image) */}
                            <div className="mt-8">
                                <h4 className="text-lg font-medium">4. Hạn chế của dân chủ tư sản</h4>
                                <p className="mt-2">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div className="space-y-4">
                                <div className="rounded-lg w-full h-[250px] overflow-hidden">
                                    <img
                                        src="/images/bourgeois-democracy/GOP.jpg"
                                        alt="Private Property Protection - Core Objective"
                                        className="w-full h-full object-cover"
                                    />
                                </div>
                                <div className="rounded-lg w-full h-[250px] overflow-hidden">
                                    <img
                                        src="/images/bourgeois-democracy/street.webp"
                                        alt="Wealth Inequality - Legitimizing Social Division"
                                        className="w-full h-full object-cover"
                                    />
                                </div>
                            </div>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="flex items-center justify-center">
                                    <div className="rounded-lg w-full h-[200px] overflow-hidden">
                                        <img
                                            src="/images/bourgeois-democracy/vote.jpg"
                                            alt="US Election System - Two-party Democracy"
                                            className="w-full h-full object-cover"
                                        />
                                    </div>
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <h4 className="text-lg font-medium">Khủng hoảng tài chính 2008</h4>
                                    <p>
                                ...
                                <div className="flex items-center justify-center">
                                    <div className="rounded-lg w-full h-[200px] overflow-hidden">
                                        <img
                                            src="/images/bourgeois-democracy/economy-crash.webp"
                                            alt="2008 Financial Crisis - Bank Bailouts"
                                            className="w-full h-full object-cover"
                                        />
                                    </div>
                                </div>
                            ...
                            {/* 3. Phong trào Áo vàng ở Pháp */}
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <h4 className="text-lg font-medium">Phong trào Áo vàng ở Pháp</h4>
                                    <p>
                                ...
                                <div className="flex items-center justify-center">
                                    <div className="rounded-lg w-full h-[200px] overflow-hidden">
                                        <img
                                            src="/images/bourgeois-democracy/ao-vang.jpg"
                                            alt="Yellow Vests Movement France - Popular Discontent"
                                            className="w-full h-full object-cover"
                                        />
                                    </div>
                                </div>
                            ...
                            {/* 4. Bất bình đẳng kinh tế gia tăng */}
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <h4 className="text-lg font-medium">Bất bình đẳng kinh tế gia tăng</h4>
                                    <p>
                                ...
                                <div className="flex items-center justify-center">
                                    <div className="rounded-lg w-full h-[200px] overflow-hidden">
                                        <img
                                            src="/images/bourgeois-democracy/economy-imbalance.jpg"
                                            alt="Economic Inequality - Wealth Gap"
                                            className="w-full h-full object-cover"
                                        />
                                    </div>
                                </div>
                            ...
                            {/* Conclusion (no image) */}
                            <div className="mt-8">
                                <p className="p-4 bg-red-50 rounded-lg">
